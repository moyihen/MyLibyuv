 ...
 * 类说明：
 */
public class StarGroupView_2 extends FrameLayout {
    ...
    public StarGroupView_2(@NonNull Context context) {
        this(context, null);
    }

    public StarGroupView_2(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StarGroupView_2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
